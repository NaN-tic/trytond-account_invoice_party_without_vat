...
class AccountInvoicePartyWithoutVatTestCase(unittest.TestCase):
    '''
    Test Account Invoice Party Without Vat module.
    '''

    def setUp(self):
        trytond.tests.test_tryton.install_module('account_invoice_party_without_vat')

    def test0005views(self):
        '''
        Test views.
        '''
        test_view('account_invoice_party_without_vat')
